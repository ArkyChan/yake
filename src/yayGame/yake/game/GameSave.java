...
public class GameSave {
    ...
    {		
    	"yayGame.yake.game.PlayerWeapon",
    	"yayGame.yake.game.AIAdapter",
		"yayGame.yake.game.Cmd",
		"yayGame.yake.game.EdictFindFilter",
		"yayGame.yake.game.EdictIterator",
		"yayGame.yake.game.EndianHandler",
		"yayGame.yake.game.EntBlockedAdapter",
		"yayGame.yake.game.EntDieAdapter",
		"yayGame.yake.game.EntDodgeAdapter",
		"yayGame.yake.game.EntInteractAdapter",
		"yayGame.yake.game.EntPainAdapter",
		"yayGame.yake.game.EntThinkAdapter",
		"yayGame.yake.game.EntTouchAdapter",
		"yayGame.yake.game.EntUseAdapter",
		"yayGame.yake.game.GameAI",
		"yayGame.yake.game.GameBase",
		"yayGame.yake.game.GameChase",
		"yayGame.yake.game.GameCombat",
		"yayGame.yake.game.GameFunc",
		"yayGame.yake.game.GameMisc",
		"yayGame.yake.game.GameSVCmds",
		"yayGame.yake.game.GameSave",
		"yayGame.yake.game.GameSpawn",
		"yayGame.yake.game.GameTarget",
		"yayGame.yake.game.GameTrigger",
		"yayGame.yake.game.GameTurret",
		"yayGame.yake.game.GameUtil",
		"yayGame.yake.game.GameWeapon",
		"yayGame.yake.game.Info",
		"yayGame.yake.game.ItemDropAdapter",
		"yayGame.yake.game.ItemUseAdapter",
		"yayGame.yake.game.Monster",
		"yayGame.yake.game.PlayerClient",
		"yayGame.yake.game.PlayerHud",
		"yayGame.yake.game.PlayerTrail",
		"yayGame.yake.game.PlayerView",
		"yayGame.yake.game.SuperAdapter",
		"yayGame.yake.game.monsters.M_Actor",
		"yayGame.yake.game.monsters.M_Berserk",
		"yayGame.yake.game.monsters.M_Boss2",
		"yayGame.yake.game.monsters.M_Boss3",
		"yayGame.yake.game.monsters.M_Boss31",
		"yayGame.yake.game.monsters.M_Boss32",
		"yayGame.yake.game.monsters.M_Brain",
		"yayGame.yake.game.monsters.M_Chick",
		"yayGame.yake.game.monsters.M_Flash",
		"yayGame.yake.game.monsters.M_Flipper",
		"yayGame.yake.game.monsters.M_Float",
		"yayGame.yake.game.monsters.M_Flyer",
		"yayGame.yake.game.monsters.M_Gladiator",
		"yayGame.yake.game.monsters.M_Gunner",
		"yayGame.yake.game.monsters.M_Hover",
		"yayGame.yake.game.monsters.M_Infantry",
		"yayGame.yake.game.monsters.M_Insane",
		"yayGame.yake.game.monsters.M_Medic",
		"yayGame.yake.game.monsters.M_Mutant",
		"yayGame.yake.game.monsters.M_Parasite",
		"yayGame.yake.game.monsters.M_Player",
		"yayGame.yake.game.monsters.M_Soldier",
		"yayGame.yake.game.monsters.M_Supertank",
		"yayGame.yake.game.monsters.M_Tank",
		"yayGame.yake.game.GameItems",
		// DANGER! init as last, when all adatpers are != null
		"yayGame.yake.game.GameItemList"
    };

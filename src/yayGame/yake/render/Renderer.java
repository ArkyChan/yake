...
public class Renderer {
    ...
    static RenderAPI fastRenderer = new yayGame.yake.render.fast.Misc();
    // rst: lets use the fast renderer from now on
    //static RenderAPI basicRenderer = new yayGame.yake.render.basic.Misc();
